...
(function ($) {
  $.GoogleCalendarEvents = function (options) {
    var defaults = {
      apiKey: 'AIzaSyC4fhz6UDbTCFXtLo5ot-4_yARvUYJHcsg',
      calendarId: 'ntcupdate@gmail.com',
      element: '#gcal',
      maxResults: 15,
      displayCount: false,
      dateLabel: "When:",
      locationLabel: "Where:",
      descriptionLabel: "About The Event:",
      groupDates: false
    };
      ...
      for(var i = 0; i < events.length; i++) {
        ...
        if(options.groupDates) {
          ...
          if( groupDate.toString() === new Array(day, month, year).toString() ) {
            eventhtml =
              '<span class="google_event_title"><a href="../../js/'+eventLink+'" rel="'+eventTitle+'">'+eventTitle+'</a></span> '+
